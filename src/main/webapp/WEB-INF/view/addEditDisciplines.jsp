	...
	<div id="container">
		<div id="main">
			...
			<a href="${pageContext.request.contextPath}/index.html">На
				главную </a>&nbsp;&nbsp; <a
				href="${pageContext.request.contextPath}/disciplines/list.html">Назад</a>
			<h4 align="center">${message}</h4>
			
			<div id="tbl">
				<center>
					<form:form method="POST" commandName="disciplines"
						action="${pageContext.request.contextPath}/disciplines/${addedit}.html">
						<table>
							<tbody>
								<tr>
									<td>Название:</td>
